<template>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4">
        <div>
            <h3 class="text-lg"><b>Add New Frontline Service Data</b></h3>
        </div>
    ...
    <div class="py-4 px-4 mb-5 rounded-md shadow-md">
        <form class="space-y-6" @submit.prevent="saveFrontlineService">
            <div class="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 gap-4">
                <div class="pb-1">
                    ...
                    <div class="mt-1">
                        <select name="permit_type_id" id="permit_type_id" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" style="text-transform: 'capitalize';" v-model="form.permit_type_id" >
                ...
                <div class="pb-1 col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="text" name="permit_no" id="permit_no" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Permit No." v-model="form.permit_no" >
                ...
                <div class="pb-1 col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="text" name="client_name" id="client_name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Complete Name of Client/ Representative" v-model="form.client_name" >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4">
                <div class="pb-1">
                    ...
                    <div class="mt-1">
                        <select name="gender" id="gender" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="form.gender">
...
const saveFrontlineService  = async () => {
    await storeFrontlineService({ ...form })
}
