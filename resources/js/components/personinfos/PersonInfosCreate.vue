<template>
    <form class="space-y-6" @submit.prevent="savePersonInfo">
        ...
        <div class="float-right py-4">
            <input type="hidden" name="organization" id="organization" v-model="form.organization" >
...
const form = reactive({
    ...
    contact_no: '',
    email_add: '',
    organization: 'DENR - PENRO Marinduque',
    person_type: '1'
})
