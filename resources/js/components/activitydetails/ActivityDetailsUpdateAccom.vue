        ...
        <div class="space-y-4 rounded-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 xl:grid-cols-6 gap-4">
                ...
                <div class="pb-1 col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="number" name="actual_men" id="actual_men" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activitydetail.actual_men">
                ...
                <div class="pb-1 col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="number" name="actual_women" id="actual_women" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activitydetail.actual_women">
                ...
                <div class="pb-1 col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="number" name="actual_lgbtq" id="actual_lgbtq" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activitydetail.actual_lgbtq">
