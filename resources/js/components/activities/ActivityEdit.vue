<template>
    <form class="space-y-6" @submit.prevent="editActivity">
        <div class="space-y-4 rounded-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                <div class="pb-1">
                    ...
                    <div class="mt-1">
                        <select name="activity_type" id="tyactivity_typepe" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                ...
                <div class="pb-1 col-span-2">
                    ...
                    <div class="mt-1">
                        <textarea name="gad_activity" id="gad_activity"
                                ...
                                v-model="activity.gad_activity"></textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                <div class="pb-1">
                    ...
                    <div class="mt-1">
                        <input type="date" name="date_conducted" id="date_conducted"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                v-model="activity.date_conducted">
                ...
                <div class="pb-1 col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="text" name="place_conducted" id="place_conducted" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activity.place_conducted">
                ...
                <div class="pb-1 col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="text" name="resource_speakers" id="resource_speakers" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activity.resource_speakers">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-6 gap-4">
                <div class="pb-1 col-span-3">
                    ...
                    <div class="mt-1">
                        <textarea name="remarks" id="remarks" rows="2"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                v-model="activity.remarks"></textarea>
                ...
                <div class="pb-1 col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="text" name="gad_budget_allotment" id="gad_budget_allotment" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activity.gad_budget_allotment">
                ...
                <div class="pb-1 col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="text" name="gad_allocated" id="gad_allocated" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activity.gad_allocated">
                ...
                <div class="pb-1 col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="text" name="gad_remaining_budget" id="gad_remaining_budget" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="activity.gad_remaining_budget">
...
const { errors, activity, getActivity, updateActivity } = useActivities()
