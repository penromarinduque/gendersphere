...
Route::middleware('auth')->group(function () {
    ...
    // Person Info
    Route::get('/personinfos', function () {
    ...
    // GAD Plan and Budget
    Route::get('/planbudgets', function () {
    ...
    // Frontline Services
    Route::get('/frontlineservices', function () {
    ...
    Route::get('/maintenance/committeepositions', function () {
    ...
    })->name('maintenance.committeepositions');

    // Maintenance - Goals
    Route::get('/maintenance/goals', function () {
    ...
    })->name('maintenance.causegenderissues');

    // Maintenance - GAD Objectives
    Route::get('/maintenance/objectives', function () {
    ...
    Route::get('/maintenance/frontlineservicetypes', function () {
