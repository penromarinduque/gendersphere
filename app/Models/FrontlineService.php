...
class FrontlineService extends Model
{
    ...
    protected $fillable = ['permit_type_id', 'client_name', 'gender', 'date_applied', 'date_released', 'barangay_id'];

    public function getFrontlineServicesByPermitType($permit_type_id, $year)
    {
        return $this->select('client_name', 'gender', 'date_applied', 'date_released', 'barangay_name', 'municipality_name')
