...
class DashboardController extends Controller
{
    public function summary(Request $request)
    {
        ...
        $training_count = TrainingInstance::whereYear('training_start', $year)->count();
        ...
        if (!$user?->is_super_admin) {
            ...
            $training_count = TrainingInstance::whereYear('training_start', $year)->where('office_id', $office_id)->count();
        }
        return (object)[
            'totals' => [
                'users' => $user_count,
